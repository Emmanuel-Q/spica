...
<div class="main-panel">
    <!-- Section to view all published sections -->
    <div class="content-wrapper">
        <div class="">
            <table class="table table-hover">
                ...
                <tbody>
                    <h2>Unpublished Sections</h2>
                    <?php
                    // Fetch only unpublished sections with corresponding page titles from the database
                    $sections = get_unpublished_sections_with_page_titles();
